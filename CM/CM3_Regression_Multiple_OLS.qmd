...
## Reminder: Orthogonal Projection - 1/4 {.build}
...
& = \mathbb{Cov}[\mathbf{B} \mathbf{y}; (\mathbf{X}^T\mathbf{X})^{-1}\mathbf{X}^T\mathbf{y}]\\
& = \mathbf{B} \mathbb{Cov}[\mathbf{y}; \mathbf{y}] [(\mathbf{X}^T\mathbf{X})^{-1}\mathbf{X}^T]^T\\
...
& = \mathbb{Cov}[\mathbf{P}^{\mathbf{X}^\bot} \mathbf{y}; \mathbf{P}^{\mathbf{X}} \mathbf{y}] \\
& = \mathbf{P}^{\mathbf{X}^\bot} \mathbb{Cov}[\mathbf{y}; \mathbf{y}] [\mathbf{P}^{\mathbf{X}}]^T \\
& = \mathbf{P}^{\mathbf{X}^\bot} [\sigma^2 \mathbf{I}_n] \mathbf{P}^{\mathbf{X}} \\
& = \sigma^2 \mathbf{P}^{\mathbf{X}^\bot} \mathbf{P}^{\mathbf{X}} \\
& = \mathbf{0}
\end{aligned}
$$
