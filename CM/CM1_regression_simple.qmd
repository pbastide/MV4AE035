...
* https://pbastide.github.io/MT6BM020/

* Dépôt `git`: https://github.com/pbastide/MT6BM020
...
$$
\hat{\beta}_1 = \sum_{i=1}^n p_i y_i \qquad p_i = \frac{(x_i - \bar{x})}{s_{\mathbf{x}}^2}
$$
